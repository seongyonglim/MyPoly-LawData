# PowerShell script to apply commit message fixes
# This uses git filter-branch to rewrite commit messages

Write-Host "========================================"
Write-Host "Apply Commit Message Fixes"
Write-Host "========================================"
Write-Host ""
...
Write-Host "This will rewrite Git history to fix broken Korean commit messages."
Write-Host ""
Write-Host "WARNING: This will rewrite history. Make sure:"
Write-Host "  - No one else is working on this branch"
Write-Host "  - You have a backup"
Write-Host "  - You understand the implications"
Write-Host ""
...
$filterScript | Out-File -FilePath "msg_filter.sh" -Encoding UTF8 -NoNewline

Write-Host "Created msg_filter.sh"
Write-Host ""
Write-Host "To apply fixes using Git Bash:"
Write-Host "  1. Open Git Bash"
Write-Host "  2. Navigate to this directory"
Write-Host "  3. Run: git filter-branch -f --msg-filter 'bash msg_filter.sh' HEAD~35..HEAD"
Write-Host "  4. After completion: git push --force-with-lease origin main"
Write-Host ""
Write-Host "Or use interactive rebase:"
Write-Host "  1. Open Git Bash"
Write-Host "  2. Run: git rebase -i HEAD~35"
Write-Host "  3. Change 'pick' to 'reword' for broken commits"
Write-Host "  4. Enter English messages from COMMIT_MESSAGE_FIXES.md"
Write-Host ""
